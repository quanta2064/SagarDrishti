...
export const IncidentTable: React.FC<IncidentTableProps> = ({
  ...
  const [sortField, setSortField] =
    useState<keyof DetectionItem>('confidence');
    ...
    >
      ...
      >
            ...
            {filteredDetections.map((det) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {det.shadow_verified &&
                    det.acoustic_shadow_length_m != null ? (
                      <span
                        style={{
                          display:
                            'inline-flex',
        ...
        {filteredDetections.length === 0 && (
          ...
          >
            No hazard detections match the
